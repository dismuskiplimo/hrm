                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('leave_category') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="leave_category" id="leave_category" class="form-control" value="{{ old('leave_category') }}" placeholder="Enter client name..">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('leave_category_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea" name="leave_category_description" id="leave_category_description" placeholder="Enter client description.." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('leave_category_description') }}</textarea>
                                @if ($errors->has('leave_category'))
                                <span class="help-block">
