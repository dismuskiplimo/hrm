    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Details of leave category</h3>
            ...
            <div class="box-body">
                <a href="{{ url('/setting/leave_categories') }}" class="btn btn-primary btn-flat"><i class="fa fa-arrow-left"></i> Back</a>
                <hr>
                <table id="example1" class="table table-bordered table-striped">
                    <tbody>
                        <tr>
                            <td width="25%">Category Name</td>
                            <td width="75%">{{ $leave_category['leave_category'] }}</td>
                        </tr>
                        <tr>
                            <td>Description</td>
