        ...
        <div class="box box-default">
            ...
            <form action="{{ url('setting/job-types/store') }}" method="post" name="job_type_add_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('job_type') ? ' has-error' : '' }} has-feedback">
                                <input type="text" name="job_type" id="job_type" class="form-control" value="{{ old('job_type') }}" placeholder="Enter job name..">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('job_type_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="textarea" name="job_type_description" id="job_type_description" placeholder="Enter job description.." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('job_type_description') }}</textarea>
                                @if ($errors->has('job_type'))
                                <span class="help-block">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> Add job type</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
