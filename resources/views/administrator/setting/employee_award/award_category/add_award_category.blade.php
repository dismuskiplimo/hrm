...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Add Award Category</li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="box box-default">
      <div class="box-header with-border">
        <h3 class="box-title">Add Award Category</h3>
      ...
      <form action="{{ url('/setting/award_categories/store') }}" method="post" name="award_add_form">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              @else
              <p class="text-yellow">Enter Awards Title. All field are required. </p>
              @endif
            </div>
            <!-- /.Notification Box -->
            ...
            <div class="col-md-6">
              ...
              <div class="form-group{{ $errors->has('award_title') ? ' has-error' : '' }} has-feedback">
                <input type="text" name="award_title" id="award_title" class="form-control" value="{{ old('award_title') }}" placeholder="Enter Award Name/Title..">
        ...
        <div class="box-footer">
          ...
          <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> Add award List</button>
        </div>
      </form>
    </div>
    <!-- /.box -->
