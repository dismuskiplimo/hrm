    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Details of client type</h3>
            ...
            <div class="box-body">
                <a href="{{ url('/setting/client-types') }}" class="btn btn-primary btn-flat"><i class="fa fa-arrow-left"></i> Back</a>
                <hr>
                <table id="example1" class="table table-bordered table-striped">
                    <tbody>
                        <tr>
                            <td width="25%">Client Type</td>
                            <td width="75%">{{ $client_type->client_type }}</td>
                        </tr>
                        <tr>
                            <td>Client Type Description</td>
